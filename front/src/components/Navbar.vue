...
<template>
  <el-header class="header" style="background-color: #ffffff; height: 60px">
    <div class="navbar-left">
      <img :src="logo" alt="网站 Logo" class="navbar-logo" @click="router.push('/home')">
    </div>
    <el-menu mode="horizontal" text-color="#000000" active-text-color="#5D9CEC" class="top-menu"
      :default-active="activeIndex">
      <el-menu-item index="/home" @click="router.push('/home')">首页</el-menu-item>
      <el-menu-item index="/article" @click="router.push('/article')">文章列表</el-menu-item>
      <el-menu-item index="/video" @click="router.push('/video')">视频课堂</el-menu-item>
      <el-menu-item index="/forum" @click="router.push('/forum')">同伴互助</el-menu-item>
    </el-menu>
